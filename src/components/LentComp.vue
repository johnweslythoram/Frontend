<template>
    ...
    :key="trans.id">
        <div class="d-flex justify-content-between align-items-center flex-column flex-md-row">
            ...
            <p><span>Expected date : </span>{{ formatDate(trans.lent_date) }}</p>
        </div>
        <div class="d-flex justify-content-between">
            <p class="fw-normal"><span class="fw-bold">To: </span>{{ trans.borrower_name }}</p>
        ...
        methods:{
            async TransComp(trans){
                const params = {
                  ...
                  borrowed_or_lent : 'lent',
                  name_of_person : trans.borrower_name,
                }
                try{
                    this.loading = true
                    const response = await api.post(`lent/delete/${trans.id}`)
            ...
            async getTransacDetails(){
                try{
                    ...
                    const response = await api.get(`/lent/all/${UserId}`)
